...
this as a dataframe with the following format:
    ...
    ## $ method                    <fct> , , , Microscopy, , , Microscopy, Mi...
    ## $ rdt_type                  <fct> , , , , , , , , , , , , , , , , , , ...
    ## $ pcr_type                  <lgl> NA, NA, NA, NA, NA, NA, NA, NA, NA, ...
    ## $ malaria_metrics_available <fct> false, false, false, true, false, fa...
    ## $ location_available        <fct> true, true, true, true, true, true, ...
    ## $ permissions_info          <fct> No permission to release data, No pe...
    ## $ citation1                 <fct> Jambou, R., Ranaivo, L., Raharimalal...
    ## $ citation2                 <fct> Jambou, R. (2008) personal communica...
...
and returns this as either a spatialPolygon or data.frame object.
    ...
    ## Source: "/tmp/RtmpT5GXYN/shp/admin0_map_2013.shp", layer: "admin0_map_2013"
    ## with 1 features
    ## It has 8 fields
    ## OGR data source with driver: ESRI Shapefile 
    ## Source: "/tmp/RtmpT5GXYN/shp/admin1_map_2013.shp", layer: "admin1_map_2013"
    ## with 22 features
    ## It has 5 fields
