...
# })
 ...
 # test_that("error messages are appropriate to given error",{
  ...
  expect_warning(getPR(country = c("kenya","ngeria"), species = "both"), regexp = "PR data points are not available")
  expect_message(getPR(country = c("kenya","ngeria"), species = "both"), regexp = "PR data points are not available")
  expect_error(getPR(country = c("kenya","ngeria"), species = "both"), regexp = NA)
  expect_warning(getPR(country = c("kenya","Australia"), species = "both"), regexp = "PR data points are not available")
  expect_message(getPR(country = c("kenya","Australia"), species = "both"), regexp = "PR data points are not available")
  ...
  expect_error(getPR(country = c("Ngeria","Australia"), species = "both"), regexp = "PR data points are not available")
  expect_warning(getPR(country = c("kenya","Ngeria","Australia"), species = "both"), regexp = "PR data points are not available")
  expect_warning(getPR(country = c("kenya","Ngeria","Australia"), species = "both"), regexp = "PR data points are not available")
  expect_message(getPR(country = c("kenya","Ngeria","Australia"), species = "both"), regexp = "PR data points are not available")
