...
context("Using is_available to check whether there are PR points for specified country/countries in the MAP database")
...
test_that("is_available returnes the proper data frame if full_results is specified", {
