...
test_that('All combinations of spatially aligned requests work', {
  ...
  #p <- autoplot_MAPraster(MDG_PfPR2_10_range) # this works
  #autoplot_MAPraster(MDG_PfPR2_10_range) # This goes funky. Need invisible()
  ...
  MDG_tvs_tvs <- getRaster(surface = c("PfPR2-10", 'Pf Incidence'), shp = MDG_shp, year = c(2012, 2010))
