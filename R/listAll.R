#' List countries with available PfPR data.
#'
#' \code{listAll} lists all countries for which there are publicly available PfPR datapoints.
#'
#' @return \code{listAll} returns a list of countries for which PfPR points are publicly available.
#'
#' @examples
#' listAll()
#' @export
